    ...
    public class DiaryEntriesController : BaseApiController
    {
        ...
        public HttpResponseMessage Post(DateTime diaryId, [FromBody]DiaryEntryModel model)
        {
            try
            {
                ...
                if (entity == null)
                {
                    return Request.CreateErrorResponse(HttpStatusCode.BadRequest, "Couldn't read diary entry in body");
                }
                ...
                {
                    return Request.CreateErrorResponse(HttpStatusCode.BadRequest, "Couldn't save to database.");
                }
